...
public class CrawllingTarget {
	...
	public CrawllingTarget(String shop_url, String shop_name, String shop_description, int category1, int category2, String product_name, String product_price, String product_image,
	...
	public CrawllingTarget(int seq, String shop_url, String shop_name, String shop_description, int category1, int category2, String product_name, String product_price, String product_image,
			String product_url, String page_selector,String page_size_selector, int page_size, int scroll_type) {
		this.seq=seq;
		this.shop_url = shop_url;
		this.shop_name = shop_name;
	...
	public String toString() {
		return "CrawllingTarget [seq=" + seq + ", shop_url=" + shop_url + ", shop_name=" + shop_name
				...
				+ ", product_name=" + product_name + ", product_price=" + product_price + ", product_image="
				+ product_image + ", product_url=" + product_url + ", page_selector=" + page_selector
				+ ", page_size_selector=" + page_size_selector + ", page_size=" + page_size + ", scroll_type="
				+ scroll_type + "]";
	}
